...
if __name__ == "__main__":
    ...
    desired_date_local = desired_date.astimezone(pytz.timezone(desired_timezone))

    # Format the date as a string
    formatted_date = desired_date_local.strftime('%Y-%m-%d')

    print(formatted_date)


 
    resistances, supports, retail, alarm_plays = get_briefing(formatted_date)
